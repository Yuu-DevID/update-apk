const { proto, delay, getContentType, extractMessageContent, areJidsSameUser } = require('baileys')
...
exports.smsg = (client, m, store) => {
    ...
    if (m.message) {
        ...
        m.body = m.message.conversation || m.caption || m.msg.caption || m.msg.text || (m.mtype == 'listResponseMessage') && m.msg.singleSelectReply.selectedRowId || (m.mtype == 'buttonsResponseMessage') && m.msg.selectedButtonId || (m.mtype == 'viewOnceMessage') && m.msg.caption || m.text
