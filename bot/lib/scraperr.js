...
function formatDuration(seconds) {
  ...
  if (h > 0) {
      // Jika ada jam, format menjadi HH:MM:SS
      let hh = String(h).padStart(2, "0");
      return `${hh}:${mm}:${ss}`;
  } else {
      // Jika hanya menit dan detik, format menjadi MM:SS
      return `${mm}:${ss}`;
  }
}

// async function ytPlayMp3(linknya) {
//         try {
//                 const cookies = [
//                   { name: "cookie1", value: 'VISITOR_PRIVACY_METADATA=CgJJRBIEGgAgHQ%3D%3D;__Secure-3PSID=g.a000tAh7uFK2GY1tYmGxavf5ObYRksg7xQhClqUUAedwqU4RrE3NQCbm0T_fBRI3qByEz_hYJgACgYKAZ8SARESFQHGX2MimM6OHhToxUAcWFvyo2E-5RoVAUF8yKpe4N9FJoPKlZCpw6K45GoF0076;__Secure-1PSIDTS=sidts-CjEBmiPuTRWyJGXDkPSyuvu7wEUFZiJR75NodYdnXYcBnoSSkM1PLI3xLTLci4Hm_rbfEAA;SAPISID=ld30xfsZ3MjBL6ML/AEXi2F7iXND2n2NsU;__Secure-1PSIDCC=AKEyXzX4tXdcxl4l9KcJ9Gpx6epeG6rI78HtrokgntVrF8LD8mFYjdW01x67tfE3mhKdWmuFhg;SSID=Aa1osd4bvXpoY-PVR;__Secure-1PAPISID=ld30xfsZ3MjBL6ML/AEXi2F7iXND2n2NsU;__Secure-1PSID=g.a000tAh7uFK2GY1tYmGxavf5ObYRksg7xQhClqUUAedwqU4RrE3NlnvkkOdTSsGSpc5L111byAACgYKAaISARESFQHGX2MiTLJPEo3UnkJF_aUo5QAVdRoVAUF8yKqHgmG_TefOMXoYRWMmdifq0076;__Secure-3PAPISID=ld30xfsZ3MjBL6ML/AEXi2F7iXND2n2NsU;__Secure-3PSIDCC=AKEyXzV2wMvSWJRFmpD6oKbdQNKC2EW2McxWVfvcP5RDu_iT25lijOgy_o3HTUNn4NToYQ4t3A;__Secure-3PSIDTS=sidts-CjEBmiPuTRWyJGXDkPSyuvu7wEUFZiJR75NodYdnXYcBnoSSkM1PLI3xLTLci4Hm_rbfEAA;LOGIN_INFO=AFmmF2swRQIhAOHhIZygPtjKkOU-r8h-vySosZtMlCNa_S7PXV68UbeRAiAx7qyNOWYVMwXR6C4wtndGFzssXJXx1Mtd9FJ5Lr1moQ:QUQ3MjNmd2FyQXJvWU5WNlVMQjdScW83eTVEYlQ3RDhqLUNIZzh2T0tFX1hRUXRlZ2RfTVllUVRTZGd5OFFadDJKZGVqSXhYcGt4U1VWNlhhT3NNTjE1akVpRDV1TXU1TmdIQW5vUVkxQUQ4TGZyd1JaTnJtbDVrZDlQUmtKUUdUR25hLWp4N3FFZ3BKdGlxVnpUTGpncGZ1X3lRRk1xbm5n;PREF=f6=40000000&tz=Asia.Jakarta&f5=30000&f7=100;VISITOR_INFO1_LIVE=etEPFAtRRlw' },
//                 ];
...
//                 // Buat agent sekali saja jika cookie tidak berubah
//         const agent = ytdl.createAgent(cookies, agentOptions);

//         // Ambil video ID
//         const id = ytdl.getVideoID(linknya);
...
//         // Ambil hanya audio format
//         formats.forEach((format) => {
//             if (format.mimeType.includes("audio/webm")) {
//                 audio.push(format.url);
//             }
//         });

//         // Ambil informasi penting
//         const { videoDetails } = data;
//         const { playerMicroformatRenderer: microformat } = data.player_response.microformat;

//         const result = {
//             status: true,
//             code: 200,
//             title: videoDetails.title,
//             description: videoDetails.description || "(Tidak ada deskripsi)",
//             duration: videoDetails.lengthSeconds,
//             thumb: microformat.thumbnail.thumbnails[0]?.url || "",
//             channel: microformat.ownerChannelName || videoDetails.author.name,
//             published: microformat.publishDate || "Unknown",
//             views: microformat.viewCount || "Unknown",
//             url: audio[0],
//         };
...
//         return { status: false, code: 500, message: "Failed to fetch data." };
//     }
// }
...
module.exports = {ytPlayMp3, savefromV2, ChatGpt, searchfilm,getSurah, tafsir, instagram4, capcutdl, instagram3, mediafiredll, cekkuota,tele, instagram2, kodepos, pinterest, igdl, textpro, mediafire, ffstalk, mlstalk, TikTok,surah, listsurah, ephoto, emoji}
